...
public partial class Inicio : ContentPage
{
    ...
    {
        var b1 = gridIniciar.FadeTo(0, 1000, Easing.Linear);
        var b2 = gridIniciar.ScaleTo(2.0, 1000, Easing.BounceIn);

        await Task.WhenAll(b1, b2);

        var b3 = gridIniciar.FadeTo(1, 1000, Easing.Linear);
        var b4 = gridIniciar.ScaleTo(1.0, 1000, Easing.BounceOut);
